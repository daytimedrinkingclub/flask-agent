...
from ..services.bot9_data.bot9_data_service import SaveBot9Data, GetBot9Data
from ..services.chat_data.action_service import ActionService
import json

class BotnineService:
    @staticmethod
    # this function creates a botnine action
    def create_action(chat_id, action_name, description):
        # Read the curl file


        bot9_token = TokenService.get_bot9_token(chat_id)
        chatbot_id = GetBot9Data.get_bot9_chatbot(chat_id)
    ...
    # this function builds the payload for creating a botnine action
    @staticmethod
    ...
    # this function creates a botnine instruction
    @staticmethod
